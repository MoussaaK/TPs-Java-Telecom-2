...
Question 3 : 
	a - Non on a besoin de relire tableau d'objet par tableau d'objet
	b - On a besoin du nombre d'instance de Person dans le fichier pour lire correctement le bon nombre de person
